function [pj] = get_bivarPrior_GRflat(b,zprime,o_plotPrior,o_printPrior)
...
prr = ones(size(RR));                           % Distance prior
...
if o_plotPrior
    ...
    title('Joined log-prior (G-R / no distance-info)','fontSize',ftSize)
