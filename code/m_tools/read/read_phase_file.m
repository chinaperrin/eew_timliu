...
eqTime     = textscan(headerCell{4},'%s','delimiter',',');
eqDate     = eqTime{1}{1};
t0         = eqTime{1}{2};  

eqLat      = str2num(headerCell{5});
eqLon      = str2num(headerCell{6});
eqZ        = str2num(headerCell{7});
magn       = str2num(headerCell{8});
magnType   = headerCell{9};
