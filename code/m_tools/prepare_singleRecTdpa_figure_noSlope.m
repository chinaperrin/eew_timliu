function [hf,ax] = prepare_singleRecTdpa_figure_noSlope(tdpaValues,tRange)

global ftSize

% Check prepare_singleRecTdpa_figure_bak.m for plot without slopes
% Set up figure
hf = figure(12); clf; box on; grid on; whitebg('w')
ax.a1 = subplot(5,2,[1,3,5,7,9]);
ax.a2 = subplot(5,2,2);
ax.a3 = subplot(5,2,4);
ax.a4 = subplot(5,2,6);
ax.a5 = subplot(5,2,8);
...
pos4 = get(ax.a4,'position'); pos5 = get(ax.a5,'position'); %pos6 = get(ax.a6,'position');
...
ylabel(['log_{10} (pgd) [m]'],'fontSize',ftSize)
